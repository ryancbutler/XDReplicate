...
FunctionsToExport = 'Export-XDApp', 'Export-XDAppGroup', 'Export-XDDesktop', 
               'Export-XDsite', 'Import-XDAdmin', 'Import-XDAdminRole', 'Import-XDApp', 
               'Import-XDApplicationGroup', 'Import-XDDeliveryGroup', 
               'Import-XDDesktop', 'Import-XDsite', 'Import-XDTag', 
               'New-XDadminfolder'
